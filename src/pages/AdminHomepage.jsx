...
const AdminHomepage = () => {
  ...
  return (
    <div className="w-full relative [background:linear-gradient(180deg,_#612570_57%,_#87349c)] h-[836px] overflow-hidden text-left text-5xl text-darkslateblue font-inter">
      <img
        className="absolute top-[676px] left-[1131px] w-[391px] h-[218px] overflow-hidden object-contain"
        alt=""
      ...
      <div className="absolute h-[58.85%] w-[68.33%] top-[15.31%] right-[15.9%] bottom-[25.84%] left-[15.77%] text-lg text-black">
        ...
        <div className="absolute top-[392px] left-[129px] leading-[25px] inline-block w-[784px] h-[74px]">
          <p className="m-0 font-extrabold text-chocolate">
            Excessive Traffic at Ticketing Alert
          </p>
          <p className="m-0 font-medium">Entities: 42</p>
          <p className="m-0 font-medium">Location: North Ticket Counter</p>
        </div>
      ...
      />
      <img
        className="absolute top-[368px] left-[1345px] w-[100px] h-[100px] object-cover"
        alt=""
        src="/next-page@2x.png"
      />
      <img
        className="absolute top-[169px] left-[480px] w-[562px] h-[323px] object-cover"
        alt=""
        src="/image-1@2x.png"
      />
    </div>
