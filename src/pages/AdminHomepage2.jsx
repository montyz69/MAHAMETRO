...
const AdminHomepage2 = () => {
  const navigate = useNavigate();

  const onPreviosReportsContainerClick = useCallback(() => {
    navigate("/previous-reports-page");
  }, [navigate]);

  const onAddIncidentsContainerClick = useCallback(() => {
    ...
    <div className="w-full relative [background:linear-gradient(180deg,_#612570_57%,_#87349c)] h-[836px] overflow-hidden text-left text-5xl text-darkslateblue font-inter">
      ...
      <div className="absolute h-[58.85%] w-[68.33%] top-[15.31%] right-[15.9%] bottom-[25.84%] left-[15.77%] text-lg text-black">
        ...
        <div className="absolute top-[383px] left-[129px] leading-[25px] inline-block w-[784px] h-[74px]">
          <p className="m-0 font-extrabold text-red">{`Unattended/Suspicious Item Detection Alert `}</p>
          <p className="m-0 font-medium">Entities: 1</p>
          <p className="m-0 font-medium">{`Location: Platform 5 - East Entrance `}</p>
        </div>
        <img
        ...
        />
        <img
          className="absolute top-[27px] left-[18px] w-20 h-20 overflow-hidden"
          alt=""
          src="/bag-icon.svg"
        />
      ...
      <div
        ...
        onClick={onPreviosReportsContainerClick}
      >
      ...
      <div
        ...
        onClick={onAddIncidentsContainerClick}
      >
        <img
      ...
      />
      <img
        className="absolute top-[163px] left-[500px] w-[524px] h-[321px] object-cover"
        alt=""
        src="/image-2@2x.png"
      />
    </div>
